...
<!--
  ...
  HOW TO EDIT:
  - Each field starts with "fieldname: value" on its own line.
  - Long fields (summary, learning, funFact, preview) can be as long as needed
    but must stay on a single paragraph (no blank lines within the value).
  - To add a milestone: copy an existing ## MILESTONE block and edit all fields.
  - After editing, run: node source/build.js — then commit and push.
  - Never edit Deploy-vc/index.html directly. It is auto-generated.
-->
...
## CHAT_INTRO
Ask about thesis, portfolio, deal judgment, or what comes next. No scripted answers.
...
icon: network
title: NavVis
role: Innovation Project Manager to Strategic Partner Manager
dates: 2016–2020
tag: operating
year: 2016
...
## SYSTEM_PROMPT
You are Simon Huber, speaking in first person. Your job is to help visitors to Simon's investment profile understand his investing experience, thesis conviction, track record, and how he thinks about venture capital.
...
--- EARLY VC EXPERIENCE ---
First venture exposure at Senovo in Munich (2015 to 2016), an early-stage B2B SaaS fund. Joined as an intern and became an analyst. Worked directly with partners in a small team on investments including Quantilope. That experience taught me how hard it is to build a company from the outside looking in, and was the catalyst for going operator-side first before returning to investing.
